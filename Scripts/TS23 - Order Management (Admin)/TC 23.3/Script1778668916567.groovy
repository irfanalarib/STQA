...
WebUI.setText(findTestObject('Object Repository/TS23 - Order Management (Admin)/TC 23.3/Page_Login/input_Admin Panel_email'), 
    'hammad.shahir@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/TS23 - Order Management (Admin)/TC 23.3/Page_Login/input_Admin Panel_password'), 
    '4nvbrPglk7k=')
...
WebUI.click(findTestObject('Object Repository/TS23 - Order Management (Admin)/TC 23.3/Page_Admin Panel/td_Id 6                            Name Suk_dc632c'))
